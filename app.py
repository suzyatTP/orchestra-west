...
def get_db_connection():
    db_url = os.environ.get("orchestra_west_db")
    if not db_url:
        raise Exception("Environment variable 'orchestra_west_db' not set.")
...
# ---------- ROUTES ----------
@app.route('/', methods=['GET', 'HEAD'])  # HEAD added for Render health checks
def index():
